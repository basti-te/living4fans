...
export const REFERENZEN: Referenz[] = [
  {
    ...
    bilder: [
      { src: "/media/referenzen/mulica-01.jpg", alt: "Dr. Marcus Mulica mit Daumen hoch vor dem fertig montierten Highboard mit Glasvitrinen" },
      ...
      { src: "/media/referenzen/mulica-06.jpg", alt: "Behandlungsraum mit Highboard und Behandlungsstuhl" },
