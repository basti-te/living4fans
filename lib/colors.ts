...
/**
 * Klassische Farbwelt des Modulsystems (Näherungswerte für die Darstellung am
...
export const USM_COLORS: UsmColor[] = [
  ...
  { id: "mittelgrau", name: "Mittelgrau", ral: "Klassiker", hex: "#8F9491" },
  { id: "anthrazit", name: "Anthrazitgrau", ral: "RAL 7016", hex: "#464A4D" },
  { id: "graphitschwarz", name: "Graphitschwarz", ral: "Klassiker", hex: "#2C2C2E" },
  { id: "goldgelb", name: "Goldgelb", ral: "RAL 1004", hex: "#E5A82E" },
  { id: "reinorange", name: "Reinorange", ral: "RAL 2004", hex: "#DE6A28" },
  { id: "rubinrot", name: "Rubinrot", ral: "Klassiker", hex: "#8F2A3C" },
  { id: "usmgruen", name: "Grün", ral: "Klassiker", hex: "#48684E" },
  { id: "enzianblau", name: "Enzianblau", ral: "RAL 5010", hex: "#2E5E9E" },
  { id: "stahlblau", name: "Stahlblau", ral: "Klassiker", hex: "#46586A" },
  { id: "braun", name: "Braun", ral: "Klassiker", hex: "#4C3E33" },
  { id: "beige", name: "Beige", ral: "Klassiker", hex: "#CBBFA3" },
];
